...
7. **Claim** (Lambda → Jinja template → reportlab PDF; no model): letter to seller/pharmacy/dealer citing notice id, batch, remedy; if `purchase_date > published_at` add Consumer Protection Act paragraph ("sold after notice"). PDF → S3.
